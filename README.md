...
Contact Information Design and implement a production ready application for maintaining contact information.

Getting Started These instructions will get you a copy of the project up and running on your local machine for development and testing purposes. See deployment for notes on how to deploy the project on a live system.

Prerequisites Run the table script to sutable DataBase.

Change DataBase Name Into Connection String Shown Belove
